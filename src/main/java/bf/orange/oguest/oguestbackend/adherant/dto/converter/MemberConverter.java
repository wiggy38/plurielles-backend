...
public class MemberConverter {
    ...
    public Member fromRequest(MemberRequest memberRequest) {
        ...
        member.setCategory(categoryBusiness.findById(memberRequest.getCategoryId()));
        member.setFormula(formulaBusiness.findById(memberRequest.getFormulaId()));
        member.setSecteur(secteurBusiness.findById(memberRequest.getSecteurId()));
        return member;
    }
