    ...
    public class LDAPSecurityConfig extends WebSecurityConfigurerAdapter {
        ...
        protected void configure(HttpSecurity http) throws Exception {
            ...
            http.cors().and().csrf().disable()
                    ...
                    .authorizeRequests()
                    .antMatchers("/api/member/r/single/entry/**","/api/member/r/list/all","/api/member/w/insert/new","/swagger-ui/**", "/v3/api-docs/**", "/javainuse-openapi/**",  "/backend/api/auth/ldap/**", "/backend/api/user/list/**").permitAll()
